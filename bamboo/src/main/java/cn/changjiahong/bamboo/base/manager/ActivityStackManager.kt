package cn.changjiahong.bamboo.base.manager
 ...
 */
open class ActivityStackManager : ActivityLifecycleCallbacks {
    ...
    companion object {
        ...
        const val ACTIVITY_LUNCHER = "com.copallive.module_main.splash.ui"
    ...
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        ...
        if (isActivityStackEmpty) {
            val packageName: String = BambooApplication.context.packageName
            val launchIntent: Intent? =
                BambooApplication.context.packageManager.getLaunchIntentForPackage(packageName)
